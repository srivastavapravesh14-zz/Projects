...
class Chicago:
    ...
    def popular_time(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Chicago Popular Time\n Information "\
    ...
    def popular_station(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Chicago Popular Trip Stations "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
    ...
    def trip_duration(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Chicago Trip Durations "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
    ...
    def user_info(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Chicago User Information "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
