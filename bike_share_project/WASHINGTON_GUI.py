...
class Washington:
    def popular_time(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Washington Popular Time\n Information "\
        ...
        def plots_call(args):
            if args == 1:
                hour = Stats("washington")
                fig1 = hour.popular_time_hours()
                
            if args == 2:
                day = Stats("washington")
                fig1 = day.popular_time_days()
                
            if args == 3:
                months = Stats("washington")
    ...
    def popular_station(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Washington Popular Trip Stations "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
    ...
    def trip_duration(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Washington Trip Durations "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
    ...
    def user_info(self):
        ...
        #============================================================================== 
        Label1 = tk.Label(master = top, text = "Washington User Information "\
                               ,background = "#DDE7E7", font = font1\
                                   ,foreground = "#000000  ")
        Label1.place(relx = 0.08, rely = 0.02)
        #============================================================================== 
        ...
        def plots_call2(args):
            ...
            if args == 2:
                ...
                quote = "No Information in the dataset"
